...
class VasiaAndBooksTest {
    ...
    fun test1() {
        ...
        val actualResult = solve(books, order)
        assert(actualResult contentEquals intArrayOf(2, 0, 1))
    }
...
//            print("$it ")
//        }
        assert(actualResult contentEquals intArrayOf(3, 2, 0, 0, 0))
    }
...
//            print("$it ")
//        }
        assert(actualResult contentEquals intArrayOf(1, 1, 2, 0, 1, 1))
    }
}